...
// Google Map
	var locations = [
		['<div class="infobox"><h3 class="title"><a href="#contact">Head Office</a></h3><span>89A, East of Kailash, Near Church New Delhi-110065</p></div></div></div>', 28.5573374, 77.2420905]
		];
		...
		var map = new google.maps.Map(document.getElementById('map'), {
		  ...
		  zoom: 10,
			...
			styles: [ { "stylers": [ { "hue": "#27e0ff" },  {saturation: 100},
                {gamma: 1} ] } ],
			center: new google.maps.LatLng(28.5573374, 77.2420905),
